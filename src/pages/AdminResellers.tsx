...
import { Plus, Trash2, UserCheck, UserX, Eye, EyeOff, Search, Filter, ChevronDown } from 'lucide-react';
...
export default function AdminResellers() {
  ...
  const handleCreate = () => {
    ...
    const bouquet: ProtocolQuota[] = protocols
      ...
      .map(p => ({
        protocolId: p.id,
        maxAccounts: protocolLimits[p.id] || 10,
        usedAccounts: 0,
      }));
          ...
          {filtered.map((reseller, i) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">/ {reseller.maxCredits} j</p>
              </div>
